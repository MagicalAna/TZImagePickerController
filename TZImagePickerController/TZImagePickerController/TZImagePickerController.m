...
- (void)viewDidLoad {
    ...
    // 默认的外观，你可以在这个方法后重置
    self.oKButtonTitleColorNormal   = [UIColor colorWithRed:(54/255.0) green:(181/255.0) blue:(157/255.0) alpha:1.0];
    self.oKButtonTitleColorDisabled = [UIColor colorWithRed:(54/255.0) green:(181/255.0) blue:(157/255.0) alpha:0.5];
